...
const ListLink = ({ href, label }) => {
  return (
    <div className="not-prose group relative">
      ...
      <Link
        href={href}
        className="dark:group-hover:text-primary relative mx-0 flex content-between gap-0  rounded-lg bg-neutral-100 py-4 pl-5 leading-none text-black group-hover:text-blue-900 dark:bg-neutral-900 dark:text-white"
      >
        {label}
      </Link>
    </div>
